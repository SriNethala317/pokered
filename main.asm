...
INCLUDE "engine/pokemon/bond_field_moves.asm"
INCLUDE "engine/battle/resonance.asm"
INCLUDE "engine/battle/dodge_phase.asm"
INCLUDE "engine/battle/field.asm"
INCLUDE "engine/battle/improvise.asm"
INCLUDE "engine/battle/level_scaling.asm"
INCLUDE "engine/events/frenzy.asm"
