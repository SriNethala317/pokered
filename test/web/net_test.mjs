...
assert.equal(decodeLink(new Uint8Array([1, 0, 0, 0, 6, 0])), null);
assert.equal(decodeLink(new Uint8Array([1, 0, 0, 0, 0, 0])), null);
assert.deepEqual(decodeLink(encodeLink(3, [0x3fd, 0x4a8, 0x505])).records, [0x3fd, 0x4a8, 0x505]);
assert.equal(decodeLink(new Uint8Array(4 + 513 * 2).fill(1)), null);
